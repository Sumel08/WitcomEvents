...
<html>
    <head>
        <title>New Place Category</title>
                    ...
                    <div class="tab-pane active" id="tab_1_1">
                        ...
                        <div class="content-box-large">
                            ...
                            <div class="panel-body">
                                <g:form name="activityType" action="savePlaceCategory" enctype="multipart/form-data">

                                    <div class="form-group">
                                      <label for="eventName" class="col-sm-2 control-label" style="margin-top: 10px;">Category</label>
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <input type="text" class="form-control" id="category" name="category" placeholder="Place Category" >
                                      </div>
                                    </div>
