                    ...
                    <div class="tab-pane active" id="tab_1_1">
                        ...
                        <div class="content-box-large">
                            ...
                            <div class="panel-body">
                                <g:form name="activityType" action="saveActivity" enctype="multipart/form-data">

                                    <div class="form-group">
                                      <label for="eventName" class="col-sm-2 control-label" style="margin-top: 10px;">Name</label>
                                      <div class="col-sm-10" style="margin-top: 10px;">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Activity Type Name" >
                                      </div>
                                    </div>
