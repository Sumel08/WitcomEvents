                                ...
                                <g:form name="eventInfo" action="updateEvent" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10" style="margin-top: 10px;">
                                      <input type="text" class="form-control" id="eventName" name="eventName" placeholder="Event Name" value="${event.name}">
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10" style="margin-top: 10px;">
                                      <input type="text" class="form-control" id="eventCode" name="eventCode" placeholder="Event Code" value="${event.code}">
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10" style="margin-top: 10px;">
                                      <textarea class="form-control" id="description" name="description" placeholder="Description" rows="3" >${event.description}</textarea>
                                    </div>
                                  </div>
                                    ...
                                    <div class="col-sm-10" style="margin-top: 10px;">
                                      <select name="chairs" class="selectpicker" data-live-search="true" multiple>
                                          <g:each var="person" in="${people}">
                                            <g:if test="${event.chairs.people.id.contains(person.id)}">
