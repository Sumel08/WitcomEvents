...
class gsp_WitcomEvents_scheduleeditSchedule_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/schedule/editSchedule.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(6)
invokeTag('hiddenField','g',64,['name':("idActivity"),'id':("idActivity")],-1)
printHtmlPart(7)
})
