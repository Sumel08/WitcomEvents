...
class gsp_WitcomEvents_placecreatePlace_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/place/createPlace.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',146,['name':("placeInfo"),'action':("savePlace"),'enctype':("multipart/form-data")],2)
printHtmlPart(11)
})
