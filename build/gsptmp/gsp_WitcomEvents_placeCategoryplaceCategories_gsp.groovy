...
class gsp_WitcomEvents_placeCategoryplaceCategories_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/placeCategory/placeCategories.gsp" }
public Object run() {
Writer out = getOut()
