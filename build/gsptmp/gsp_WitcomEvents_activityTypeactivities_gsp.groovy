...
class gsp_WitcomEvents_activityTypeactivities_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/activityType/activities.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
expressionOut.print(activity.id)
printHtmlPart(9)
}
printHtmlPart(10)
})
